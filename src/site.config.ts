...
const config: SiteConfig = {
  ...
  socialCardAvatarImage: './src/content/avatar-round.png',
  ...
  themes: {
    ...
    //   'github-dark',
    // ]
    include: ['github-dark-high-contrast'],
    // include: [
    //   'andromeeda',
    //   'aurora-x',
    //   'ayu-dark',
  ...
  socialLinks: {
    github: 'https://github.com/joshtune',
    // mastodon: 'https://github.com/joshtune',
    // email: 'https://github.com/joshtune',
    linkedin: 'https://www.linkedin.com/in/joshtune',
    // bluesky: 'https://github.com/joshtune',
    // twitter: 'https://github.com/joshtune',
